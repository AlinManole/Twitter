...
const Home = () => {
    return (
        <div className="row w-50 bg-black">
            <div className="col">
            ...
            <div className="col mt-5 pt-5 border border-secondary border-1">
                <h2 className="border-bottom border-secondary border-1 rounded text-white">Accueil </h2>
            </div>
        </div>
    );
};
